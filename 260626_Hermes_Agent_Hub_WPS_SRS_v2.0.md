...
Admin은 message/event 검색 결과에서 상세 API를 통해 raw payload, session, request/response pair 정보를 확인할 수 있어야 한다.

### FR-020 GitHub Actions CI
